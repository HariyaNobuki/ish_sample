...
class Primitive:
    ...
    def __init__(self, name, encode_name ,arity ):
        """
...
class Function(Primitive):
    ...
    def __init__(self, name, encode_name,arity):
        ...
        super().__init__(name, encode_name,arity)
...
class Terminal(Primitive):
    ...
    def __init__(self, name, encode_name ,value):
        """
        ...
        """
        super().__init__(name, encode_name, arity=0)
        self._value = value
...
class SymbolTerminal(Terminal):
    ...
    def __init__(self, name , encode_name):
        """
        ...
        super().__init__(name , encode_name, value=None)
...
class EphemeralTerminal(Terminal):
    ...
    def __init__(self, name,encode_name, gen):
        """
...
class PrimitiveSet:
    ...
    def __init__(self, name, input_names):
        ...
        for name in input_names:
            ...
            self.add_symbol_terminal(name, self.encode_total, value='input')
            self.Addencode_name()
    
    def Addencode_name(self):
        self.encode_total += 1
    ...
    def add_function(self, func, arity, name=None):
        ...
        if name is None:
            name = func.__name__
        self._assert_name_unique(name)
        function_ = Function(name, self.encode_total ,arity)
        self._functions.append(function_)
        self._globals[name] = func
        self.Addencode_name()

    def add_function_with_encode(self, func, arity, name=None):
        """
        Add a function, which is internally encapsulated as a :class:`Function` object.
    ...
    def add_symbol_terminal(self, name, encode_name, value):
        """
        ...
        """
        self._assert_name_unique(name)
        t = SymbolTerminal(name , encode_name)
    ...
    def add_ephemeral_terminal(self, name,encode_name, gen):
        """
        ...
        """
        self._assert_name_unique(name)
        self._terminals.append(EphemeralTerminal(name,encode_name, gen))
