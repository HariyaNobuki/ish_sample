...
def Nguyen5():
    ...
    parser.add_argument("--X_MIN", type=int, default=-1, help="Number of hidden layers, L")
    parser.add_argument("--X_MAX", type=int, default=1, help="Number of hidden layers, L")
...
def Nonic():
    ...
    parser.add_argument("--N_VAL", type=int, default='1000')
    parser.add_argument("--X_DIM", type=int, default='1')
    parser.add_argument("--X_MIN", type=int, default=-2, help="Number of hidden layers, L")
    parser.add_argument("--X_MAX", type=int, default=2, help="Number of hidden layers, L")
    parser.add_argument("--NOISE_SD", type=int, default=0, help="Number of hidden layers, L")
    args = parser.parse_args()
    kwargs = vars(args)
